...
function ordenarProducto(producto) {
  return new Promise((resolve, reject) => {
    console.log(`Ordenando: ${producto} de Cesde C3.`);
    setTimeout(() => {
      if (producto === 'taza') {
        resolve('Ordenando una taza con el logo de Cesde C3...')
      } else {
...
function procesarPedido(respuesta) {
  return new Promise((resolve, reject) => {
    ...
    setTimeout(() => {
      resolve('Gracias por tu compra. Disfruta tu producto de Cesde C3.');
    }, 4000);
  });
}
